...
#define I2C_SPEED                        400000-1
#define RTC_I2C                          I2C2
#define RTC_I2C_CLK                      RCC_APB1Periph_I2C2
#define RTC_I2C_SCL_PIN                  GPIO_Pin_4                  /* PA.08 */
#define RTC_I2C_SCL_GPIO_PORT            GPIOH                       /* GPIOA */
#define RTC_I2C_SCL_GPIO_CLK             RCC_AHB1Periph_GPIOH
#define RTC_I2C_SCL_SOURCE               GPIO_PinSource4
#define RTC_I2C_SCL_AF                   GPIO_AF_I2C2
#define RTC_I2C_SDA_PIN                  GPIO_Pin_5                  /* PC.09 */
#define RTC_I2C_SDA_GPIO_PORT            GPIOH                       /* GPIOC */
#define RTC_I2C_SDA_GPIO_CLK             RCC_AHB1Periph_GPIOH
#define RTC_I2C_SDA_SOURCE               GPIO_PinSource5
#define RTC_I2C_SDA_AF                   GPIO_AF_I2C2
#define RTC_RX8010SJ
/* Private macro -------------------------------------------------------------*/
/* Private variables ---------------------------------------------------------*/
...
void I2C_RTC_init(void)
{
  ...
  uint8_t received_data;
   I2C_InitTypeDef  I2C_InitStructure;
	 ...
	 */
	GPIO_InitStruct.GPIO_Pin = GPIO_Pin_4 | GPIO_Pin_5; // we are going to use PB6 and PB7
	GPIO_InitStruct.GPIO_Mode = GPIO_Mode_AF;			// set pins to alternate function
	GPIO_InitStruct.GPIO_Speed = GPIO_Speed_50MHz;		// set GPIO speed
	GPIO_InitStruct.GPIO_OType = GPIO_OType_OD;			// set output to open drain --> the line has to be only pulled low, not driven high
	GPIO_InitStruct.GPIO_PuPd = GPIO_PuPd_UP;			// enable pull up resistors
	GPIO_Init(GPIOH, &GPIO_InitStruct);					// init GPIOB
  ...
  I2C_Cmd(RTC_I2C, ENABLE);
     //  swprintf(str,20,L"TEST 1..ok");
    // show_str2(10,30,str);
   I2C_start(I2C2, SLAVE_ADDRESS<<1, I2C_Direction_Transmitter); // start a transmission in Master transmitter mode
   I2C_write(I2C2, 0x1E); // write one byte to the slave
   I2C_stop(I2C2); // stop the transmission
        // swprintf(str,20,L"TEST 2..ok");
     //show_str2(10,60,str);
   I2C_start(I2C2, SLAVE_ADDRESS<<1, I2C_Direction_Receiver); // start a transmission in Master receiver mode
   received_data = I2C_read_ack(I2C2); // read one byte and request another byte
   I2C_stop(I2C2); // stop the transmission
 		    
 while(received_data&0x02==0);
      //  swprintf(str,20,L"TEST 3..ok");
     //show_str2(10,80,str);
 receive_alltime();
 
 
 Set_timer_test((int)Get_Sec());
 // I2C_Cmd(RTC_I2C, DISABLE);
}


void SMB_BAT_init(void)
{
//#define I2C1_SLAVE_ADDRESS7    0x10
#define I2C3_SLAVE_ADDRESS7    0x08

#define Command                0x01
#define ClockSpeed             20000
#define   BQ2060A_USE_I2C      I2C3
  //int N[10];
  //int pBuf;
  uint16_t* ReceivedCommand = 0, PECValue = 0;
volatile FlagStatus Status = RESET;
  ...
  GPIO_InitTypeDef GPIO_InitStruct;
	...
	RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOH, ENABLE);
      //swprintf(strx,20,L"I2C ST");
    //  show_str2(10,30,strx);	
	/* setup SCL and SDA pins
	 * You can connect I2C1 to two different
	 * pairs of pins:
	...
	GPIO_InitStruct.GPIO_Pin = GPIO_Pin_8; // we are going to use PB6 and PB7
	GPIO_InitStruct.GPIO_Mode = GPIO_Mode_OUT;			// set pins to alternate function
	GPIO_InitStruct.GPIO_Speed = GPIO_Speed_50MHz;		// set GPIO speed
	GPIO_InitStruct.GPIO_OType = GPIO_OType_OD;			// set output to open drain --> the line has to be only pulled low, not driven high
	GPIO_InitStruct.GPIO_PuPd = GPIO_PuPd_DOWN;			// enable pull up resistors
	...
	GPIO_PinAFConfig(GPIOA, GPIO_PinSource8, GPIO_AF_I2C3);	// SCL
       ...
       // GPIO_PinAFConfig(GPIOH, GPIO_PinSource9, GPIO_AF_I2C3); // ID
  ...
  /* sEE_I2C Peripheral Enable */
  I2C_Cmd(I2C3, ENABLE);
    swprintf(strx,20,L"XX:ok  ");
    show_str2(200,150,strx); 
   I2C_start(I2C3, 0x08, I2C_Direction_Transmitter); // start a transmission in Master transmitter mode
  swprintf(strx,20,L"XX:ok1");
  show_str2(200,150,strx);
   I2C_write(I2C3, 0x1E); // write one byte to the slave
   swprintf(strx,20,L"XX:ok2");
   show_str2(200,150,strx); 
