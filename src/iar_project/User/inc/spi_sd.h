...
#define SD_SPI_SCK_GPIO_SOURCE	GPIO_PinSource10
#define SD_SPI_SCK_GPIO_AF			GPIO_AF_SPI3
#define SD_SPI_SCK_GPIO_CLK		RCC_AHB1Periph_GPIOC

#define SD_SPI_MISO_PIN 			GPIO_Pin_11
#define SD_SPI_MISO_GPIO_PORT		GPIOC
#define SD_SPI_MISO_GPIO_SOURCE	GPIO_PinSource11
#define SD_SPI_MISO_GPIO_AF		GPIO_AF_SPI3
#define SD_SPI_MISO_GPIO_CLK		RCC_AHB1Periph_GPIOC

#define SD_SPI_MOSI_PIN				GPIO_Pin_12
#define SD_SPI_MOSI_GPIO_PORT		GPIOC
#define SD_SPI_MOSI_GPIO_SOURCE	GPIO_PinSource12
#define SD_SPI_MOSI_GPIO_AF		GPIO_AF_SPI3
